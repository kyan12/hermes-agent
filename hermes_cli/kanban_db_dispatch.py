...
def _dispatch_lane_task(
    ...
    *,
    ...
    if dry_run:
        ...
        if task is None or _kbw.workspace_precondition_error(task, board=board):
            return False
    ...
    *,
    ...
    if not dry_run:
        try:
            ...
            _kb._log.debug("kanban health reconciliation failed", exc_info=True)
...
def _dispatch_once_locked(
    ...
    *,
    ...
    _run_reclaim_phase(
        ...
        failure_limit=failure_limit, reconcile_orphans=reconcile_orphans, dry_run=dry_run,
    )

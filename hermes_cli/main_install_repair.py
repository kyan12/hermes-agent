...
def _configured_update_branch() -> str | None:
    """Return the installation's maintained lineage from ``update.branch``."""
    try:
...
def _resolve_update_branch(args) -> str:
    """Resolve explicit branch, configured maintained lineage, then main."""
    explicit = (getattr(args, "branch", None) or "").strip()
    return explicit or _configured_update_branch() or "main"

...
def _ready_queue_reports_for_telemetry() -> list:
    ...
    try:
        ...
        _cap = _kbd.resolve_max_in_progress(_kbd.configured_max_in_progress())
...
class GatewayKanbanWatchersMixin:
    ...
    async def _kanban_notifier_watcher(self, interval: float = 5.0) -> None:
        ...
        while self._running:
            try:
                ...
                deliveries = await _to_thread_process_service(partial(
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        # Health telemetry (mirrors `_cmd_daemon`): only eligible, below-cap
        # cards count toward the stuck window, not intentionally idle work.
        bad_ticks = 0
        last_warn_at = 0
            ...
            try:
                ...
                if not _kanban_dispatch_allowed():
                    ...
                    queue_reports = await _to_thread_process_service(
                        _ready_queue_reports_for_telemetry
                    )
